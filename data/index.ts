...
export const process = [
  ...
  {index: 2, title: "Web Design", details: "I develop high-fidelity mockups and a style guide to define the visual aesthetics and responsive layouts of the website. "},
